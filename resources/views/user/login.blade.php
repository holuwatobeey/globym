<div ng-controller="UserLoginController as loginCtrl" ng-show="loginCtrl.request_completed == true">
    ...
    <div class="row">
        <!--  form action  -->
        <form class="lw-form lw-ng-form form-horizontal col-lg-6 col-md-12 col-sm-12 col-12" 
            ...
            @if(getStoreSettings('enable_recaptcha')) 
            <div ng-if="loginCtrl.show_captcha" >
	            <lw-form-field  class="lw-recaptcha" field-for="recaptcha" v-label="Captcha" label="<?= __tr('Verify you are not robot') ?>">
	                <lw-recaptcha class="lw-form-field g-recaptcha" 
	                    ...
	                    name="recaptcha" 
	                    sitekey="[[loginCtrl.site_key]]" ng-required="loginCtrl.show_captcha">
	                </lw-recaptcha>
	            </lw-form-field>
            </div>
            @endif
            ...
            <div class="form-group">
                <button type="submit" class="lw-btn btn btn-success" title="<?=  __tr('Login')  ?>"><?=  __tr('Login')  ?></button>
            </div>
        </form>
        <!--  /form action  -->
        <div class="col-lg-6 col-md-12 col-sm-12 col-12 lw-social-login-btn text-center">
            ...
            <a class="lw-btn lw-responsive-btn btn btn-lg btn-warning lw-register-now-btn" title="<?=  __tr('Register Now')  ?>" href="<?=  route('user.register')  ?>"><?=  __tr('Register Now')  ?></a>
            <!--  button  -->
