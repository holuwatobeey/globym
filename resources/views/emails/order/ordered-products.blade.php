                      ...
                      <tbody>
                              ...
                              <tbody>
                                <tr style="font-family: Helvetica, Arial, sans-serif;">
                                  ...
                                  <td class="product" style="border-collapse: collapse; color: #777777; font-family: Helvetica, Arial, sans-serif; font-size: 14px; line-height: 21px; text-align: left; vertical-align: top; width: 175px;">
                                    ...
                                    @if(isset($items['productDiscount']) and 
                                    (!__isEmpty($items['productDiscount'])))
                                        @if($items['productDiscount']['isDiscountExist'])
                                            <strike><?= $items['formattedOldProductPrice'] ?></strike>(<span>
                                                <?= $items['productDiscount']['discount'] ?>
                                            </span>)
                                        @endif
                                    @endif
                                  </td>
                        ...
                        <tr style="font-family: Helvetica, Arial, sans-serif;">
                          <td colspan="3" class="item-col quantity" style="border-collapse: collapse; border-top: 1px solid #cccccc; color: #777777; font-family: Helvetica, Arial, sans-serif; font-size: 14px; line-height: 21px; padding-right: 10px; padding-top: 20px; text-align: right; vertical-align: top;">
                            ...
                            @if(isset($orderData['cartDiscount']) and (!__isEmpty($orderData['cartDiscount'])))
                                @if($orderData['cartDiscount']['isOrderDiscountExist'])
                          ...
                          <td class="item-col price" style="border-collapse: collapse; border-top: 1px solid #cccccc; color: #777777; font-family: Helvetica, Arial, sans-serif; font-size: 14px; line-height: 21px; padding-top: 20px; text-align: right; vertical-align: top; width: 150px;">
                            ...
                            @if(isset($orderData['cartDiscount']) 
                            and (!__isEmpty($orderData['cartDiscount'])))
                                @if($orderData['cartDiscount']['isOrderDiscountExist'])
                                    <span class="total-space" style="display: inline-block; font-family: Helvetica, Arial, sans-serif; padding-bottom: 8px;">- <?= e( $orderData['cartDiscount']['shortFormatDiscount'] ) ?></span> <br style="font-family: Helvetica, Arial, sans-serif;">
                                @endif
                            @endif
                            @if($orderData['orderDiscount'] != 0)
                            ...
                            <span class="total-space" style="color: #4d4d4d; display: inline-block; font-family: Helvetica, Arial, sans-serif; font-weight: bold; padding-bottom: 8px;"><?= e($orderData['formatedTotalOrderAmount']) ?></span>
                          </td>
                        </tr>
                      </tbody>
                    </table>
