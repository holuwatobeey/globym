...
<form 
    ...
    <div><h3 class="lw-effective-price">
        <small title="<?= __tr( 'Price based on options selections' ) ?>"><?= __tr( 'Price :' ) ?></small>
                ...
                <div class="input-group">
                   <!--  decrement of qunatity btn  -->
                    <span class="input-group-btn ">
                        <button title="<?=  __tr('Decrement')  ?>" type="button" class="btn btn-default btn-number" ng-click="productDetailsDialogCtrl.getQtyAction(false, productDetailsDialogCtrl.productData.quantity)">
                    ...
                    <span class="input-group-btn" ng-switch="productDetailsDialogCtrl.productData.isCartExist">
                        ...
                        <button title="<?=  __tr('Increment')  ?>" type="button" ng-click="productDetailsDialogCtrl.getQtyAction(true, productDetailsDialogCtrl.productData.quantity)" class="btn btn-light btn-number lw-btn btn-sm">
                        ...
                        <button 
                            ...
                            class="btn btn-primary lw-btn-process btn-sm lw-btn" 
                            title="<?=  __tr('Add to Cart')  ?>" 
                            type="submit" ng-click="productDetailsDialogCtrl.addToCart()">
                            <i class="fa fa-cart-plus"></i> <?=  __tr("Add to Cart")  ?>
                        </button>
                        <!--  / Add cart btn  -->

                        <!--  Update cart btn  -->
                        <button ng-switch-when="true"  
                            title="<?= __tr('Update Cart') ?>" 
                            type="submit" 
                            class="btn btn-primary lw-btn-process lw-btn btn-sm" 
                            ng-click="productDetailsDialogCtrl.addToCart()"> 
                            <i class="fa fa-cart-plus"></i> <?=  __tr("Update Cart")  ?>
                            <span></span>
                        </button>
                        <!--  Update cart btn   -->
                    </span>                                    
