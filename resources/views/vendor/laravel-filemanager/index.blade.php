...
<head>
<title>
    <?= e( __transliterate('general_setting', null, 'store_name', getStoreSettings('store_name') ) ) ?> : <?= __tr('Manage Store') ?> -  <?= __tr( 'File Manager' )   ?>
</title>
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><?= __tr( 'File Manager' )   ?></a>
    </div>
...
<div class="modal fade" id="uploadModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal fade" id="fileViewModal" tabindex="-1" role="dialog" aria-labelledby="fileLabel" aria-hidden="true">
    ...
    <script src="<?= __yesset(['dist/js/vendorlibs-file-manager*.js']) ?>"></script>
