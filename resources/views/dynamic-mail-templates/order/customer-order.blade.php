...
<tbody>
    ...
    <tr style="font-family: Helvetica, Arial, sans-serif;">
      <td class="free-text" style="border-collapse: collapse; color: #777777; font-family: Helvetica, Arial, sans-serif; font-size: 14px; line-height: 21px; padding: 10px 60px 0px; text-align: center; width: 100% !important;">        	{__orderProcessMailMessage__}
      </td>
    </tr>
  </tbody>
</table>
@include("dynamic-mail-templates.order.ordered-products")