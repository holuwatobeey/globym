...
class Coupon extends BaseModel
{
    ...
    /**
     * This method define the relationship b/w coupon & coupon_product option labels.
     *
     * @return array
     *---------------------------------------------------------------- */
    public function couponProduct()
    {
        return $this->hasMany(CouponProduct::class, 'coupons__id', '_id');
    }
     ...
     * @return array
     *---------------------------------------------------------------- */
    public function couponWithProduct()
    {
        return $this->hasMany(CouponProduct::class, 'coupons__id', '_id')->with('product');
    }
}
