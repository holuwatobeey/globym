...
class __Igniter extends BaseController
{
    ...
    */
    ...
    /**
      * Get ac file manager master view template
      *
      * @return void
      *---------------------------------------------------------------- */
    ...
    public function fileManagerIndex()
    {
        ...
        $browserData['file_manager_config'] = [
            'type'    => __ifIsset($inputData['type']) ? strtolower($inputData['type']) : ''
        ];

        // send data to b
        JavaScript::put($browserData);
        
        return $this->loadView('file-manager.file-manager-master');
    }
