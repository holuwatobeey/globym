...
class AddressRepository extends BaseRepository implements AddressRepositoryBlueprint
{
    /**
     ...
     * @return eloquent collection object
     *---------------------------------------------------------------- */
    public function storeAddress($inputData)
    {
        $address = new AddressModel();
        ...
        if ($address->assignInputsAndSave($inputData, $keyValues)) {
            activityLog('ID of '.$address->id.' address added.');
