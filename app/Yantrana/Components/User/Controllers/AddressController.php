...
class AddressController extends BaseController
{
    ...
    public function addressList()
    {
        ...
        $addressBreadCrumb['data']['hideSidebar'] = true;
        $addressBreadCrumb['data']['showFilterSidebar'] = false;
    ...
    public function delete($addressID, CommonPostRequest $request)
    {
        ...
        return __processResponse($processReaction, [
                    1 => __tr('Address deleted successfully.'),
                    3 => __tr('Something went wrong.'),
                    18 => __tr('Address does not exist.'),
    ...
    public function addProcess(AddressRequest $request)
    {
        ...
        return __processResponse($processReaction, [
                1 => __tr('Address stored successfully.'),
                2 => __tr('failed to store address.'),
            ], $processReaction['data']);
    }
    ...
    public function update(AddressEditRequest $request, $addressID)
    {
        ...
        // get engine reaction
        return __processResponse($processReaction, [
                1 => __tr('Address updated successfully.'),
