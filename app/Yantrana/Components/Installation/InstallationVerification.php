...
{
    protected $projectName = 'LivelyCart PRO 3.x';
    protected $problems = [];
    protected $defaultKey = 'base64:6PncJ8rnRpzk/oDcWXnf4YoTFGy7owrRgcex3n7ooIY=';
    ...
    public function verify()
    {
        ...
        try {
            ...
            if (!env('APP_KEY') or (env('APP_KEY') === $this->defaultKey)) {
                ...
                echo "<div style='$this->styleLines'>✓ New <strong style='color:green'>API KEY</strong> Generated</div>";   
                $generatedKeys = $this->generateFormEncryptionKeys();
                // store password
                updateCreateArrayFileItem('user-tech-config', 'default_rsa_passphrase', $generatedKeys['password'], [
                    'prepend_comment' => '/*
...
*/'
                ...
                // store public key
                updateCreateArrayFileItem('user-tech-config', 'default_rsa_public_key', $generatedKeys['publicKey'], [
                    'prepend_comment' => '/*
    IF you want to change some settings in config/__tech.php then do not edit that file you should use this file.
    Then you should add those overwritten settings in the following array
*/'
                ...
                // store private key
                updateCreateArrayFileItem('user-tech-config', 'default_rsa_private_key', $generatedKeys['privateKey'], [
                    'prepend_comment' => '/*
    IF you want to change some settings in config/__tech.php then do not edit that file you should use this file.
    Then you should add those overwritten settings in the following array
*/'
                ]);
                echo "<div style='$this->styleLines'>✓ New <strong style='color:green'>Form Encryption Keys</strong> Generated</div>";
            } else {
                echo "<div style='$this->styleLines'>✓ <strong style='color:green'>API KEY</strong> exists</div>";
            }
        ...
        if (empty($this->problems)) {
            try {
                ...
                echo "<div style='text-align:center;'><h1 style='color:green'>Congratulation!! All seems to be GOOD!!<br></h1>You can proceed, <h3>For security purposes, please delete <strong style='color:red;'>install.php</strong> file & <strong style='color:red;'>__install</strong> folder</h3></div><br><br> <div style='color:gray;' >You need use credentials from <strong>cred.txt</strong> to login as admin, file provided with installation</div>";
